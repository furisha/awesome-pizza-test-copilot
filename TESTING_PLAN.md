...
│
├── page-objects/
│   ├── menuPage.ts                # TC-01, TC-02, TC-03, TC-04: menu items, quantity controls
│   └── orderPage.ts               # TC-05, TC-06, TC-07, TC-08, TC-09, TC-10, TC-11, TC-12, TC-13, TC-14: order placement, lookup, status
│
├── page-manager/
│   └── pageManager.ts             # Central PageManager class
│
├── tests/
│   ├── menu.spec.ts               # TC-01, TC-02, TC-03, TC-04: menu loading, quantity controls
